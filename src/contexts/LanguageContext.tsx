...
const translations = {
  ka: {
    ...
    'home.approach.webdev.description': 'თანამედროვე, სწრაფი ვებსაიტები რომელიც კლიენტებს მოიზიდავს',
    'home.approach.webdev.benefit1': 'სრულად მობილურ მოწყობილობებზე ადაპტირებული',
    ...
    'home.approach.ads.description': 'მიზნობრივი რეკლამა რომელიც შედეგებს იღებს',
    ...
    'home.approach.ads.benefit3': 'რეგულარული რეპორტები და გამჭვირვალე კომუნიკაცია',
    'home.approach.social.description': 'სოციალური მედია სტრატეგია ბრენდის ზრდისთვის',
    ...
    'home.services.webdev.description': 'პროფესიონალური, მობილურზე ოპტიმიზირებული ვებსაიტები და ონლაინ მაღაზიები',
    'home.services.webdev.price': '₾800-დან',
    'home.services.webdev.button': 'გაიგე მეტი',

    'home.services.content.title': 'კონტენტ პროდუქცია',
    'home.services.content.description': 'პროფესიონალური ფოტო/ვიდეო სერვისები და ბრენდინგი',
    ...
    'home.services.social.description': 'სრული Instagram/Facebook გვერდების მართვა და ზრდა',
    ...
    'home.cta.description': 'დაიწყე ჩვენთან თანამშრომლობა და ნახე შენი ბიზნესის ციფრული ტრანსფორმაცია',
    'home.cta.button': 'დაიწყე პროექტი',
    'home.cta.contact': 'დაგვიკავშირდი',
    'home.cta.callNow': '📞 დარეკე ახლავე - 555 123 456',
    'home.cta.benefits': '🎁 პირველი კონსულტაცია უფასო • ✨ ბიზნეს გეგმის შემუშავება',
    ...
    'footer.brand.description': 'ჩვენ გთავაზობთ სრულ ციფრული მარკეტინგის გამოსავლებს შენი ბიზნესის ონლაინ ზრდისთვის. ვებ განვითარებიდან სოციალური მედიის მართვამდე.',
    ...
    'about.hero.description': 'ჩვენ ვქმნით ციფრული მარკეტინგის სტრატეგიებს რომელიც ბიზნესებს ეხმარება ონლაინ ზრდაში. ჩვენი გამოცდილება 3+ წელს მოიცავს 200+ წარმატებული პროექტით.',

    'about.vision.title': 'ჩვენი ხედვა',
    'about.vision.description': 'გავხდეთ წამყვანი ციფრული მარკეტინგის სააგენტო საქართველოში, ვეხმაროთ ნებისმიერი ზომის ბიზნესს მისი ონლაინ მიზნების მიღწევაში.',

    'about.values.title': 'ჩვენი ღირებულებები',
    'about.values.quality': 'ხარისხი',
    'about.values.qualityDesc': 'ვაწარმოებთ მაღალი ხარისხის გამოსავლებს რომლებიც მოლოდინს აღემატება',
    'about.values.innovation': 'ინოვაცია',
    'about.values.innovationDesc': 'ვიყენებთ ციფრული მარკეტინგის უახლეს ტრენდებს',
    'about.values.results': 'შედეგები',
    'about.values.resultsDesc': 'ვფოკუსირდებით გამზომ შედეგებზე თქვენი ბიზნესისთვის',
    ...
    'about.story.paragraph1': 'ვიფა ციფრული დაარსდა 2021 წელს იმ მიზნით, რომ საქართველოში მცირე და საშუალო ბიზნესებს ეხმარება ციფრული ტრანსფორმაციის პროცესში. ჩვენ ვიყავით თვითნასწავლები, რომლებმაც საკუთარი გამოცდილებით შეიმუშავეს უნიკალური მიდგომა.',
    'about.story.paragraph2': 'დღეს ჩვენ ვართ გუნდი, რომელიც აერთიანებს კრეატიულ და ტექნიკურ ექსპერტებს. ყოველი პროექტი ჩვენთვის გამოწვევაა, რომელსაც ვუდგებით ყველა ჩვენი ცოდნითა და გამოცდილებით.',
    'about.story.paragraph3': 'ჩვენი მისიაა თითოეული კლიენტისთვის შევქმნათ ისეთი ციფრული არსებობა, რომელიც მათ ბიზნესს რეალურ წარმატებას მოუტანს.',

    // What We Do Section
    'about.whatWeDo.title': 'რას',
    'about.whatWeDo.titleHighlight': 'ვაკეთებთ',
    'about.whatWeDo.description': 'ჩვენ გთავაზობთ სრულ ციფრული მარკეტინგის სერვისებს - ვებ განვითარებიდან ციფრული რეკლამის კამპანიებამდე.',
    ...
    'about.values.description': 'ეს პრინციპები განსაზღვრავს ჩვენს მუშაობას და დამოკიდებულებას კლიენტებთან.',
    ...
    'about.team.ceo.bio': 'ვებ განვითარების სფეროში 4+ წლიანი გამოცდილება. პასუხისმგებელია ტექნიკურ გადაწყვეტებსა და პროექტების მართვაზე.',
    ...
    'about.team.creative.bio': 'კრეატიული სტრატეგიის და ბრენდინგის ექსპერტი. პასუხისმგებელია ყველა კრეატიულ პროცესზე.',
    ...
    'about.team.developer.bio': 'ციფრული რეკლამისა და SEO-ს სპეციალისტი. პასუხისმგებელია მარკეტინგის კამპანიებზე.',
    ...
    'about.cta.description': 'მოდი განვიხილოთ თქვენი პროექტი და შევქმნათ ხარისხიანი პროდუქტი ერთად',
    ...
    'services.hero.description': 'ჩვენ გთავაზობთ ღია ციფრული მარკეტინგის სერვისებს შენი ბიზნესის ონლაინ ზრდისთვის.',

    // Services for Navigation
    'services.webdev.title': 'ვებ განვითარება',
    'services.advertising.title': 'ციფრული რეკლამა',

    'services.webdev.description': 'თანამედროვე, რესპონსული ვებსაიტები და ონლაინ მაღაზიები',
    ...
    'services.ads.description': 'Google Ads და სოციალური მედიის სარეკლამო კამპანიები',
    ...
    'services.content.description': 'პროფესიონალური ფოტო/ვიდეო კონტენტი და ბრენდინგი',
    ...
    'startProject.hero.description': 'მოგვითხარი შენი ბიზნესის შესახებ და ჩვენ შევქმნით ინდივიდუალურ ციფრული მარკეტინგის სტრატეგიას შენთვის.',
    ...
    'startProject.services.website.description': 'პროფესიონალური, მობილურზე ოპტიმიზირებული ვებსაიტები და ონლაინ მაღაზიები',

    'startProject.services.content.title': 'კონტენტ პროდუქცია',
    'startProject.services.content.description': 'პროფესიონალური ფოტო/ვიდეო სერვისები და ბრენდინგი',

    'startProject.services.social.title': 'სოციალური მედია',
    'startProject.services.social.description': 'სრული Instagram/Facebook მართვა და ზრდა',

    'startProject.services.ads.title': 'ციფრული რეკლამა',
    'startProject.services.ads.description': 'Facebook/Instagram რეკლამების მართვა და ოპტიმიზაცია',
    ...
    'startProject.form.businessNamePlaceholder': 'შენი ბიზნესის ან კომპანიის სახელი',
    ...
    'startProject.errors.submitError': 'პროექტის გაგზავნისას მოხდა შეცდომა. გთხოვთ სცადოთ თავიდან.',

    // Footer
    'startProject.footer.trustIndicators': ' შენი ინფორმაცია დაცულია •  უფასო კონსულტაცია •  სწრაფი პასუხი',

    // SEO Meta Tags
    'seo.home.title': 'ვიფა ციფრული - ციფრული მარკეტინგის სააგენტო საქართველოში',
    'seo.home.description': 'ვიფა ციფრული - წამყვანი ციფრული მარკეტინგის სააგენტო საქართველოში. ვებ განვითარება, სოციალური მედიის მართვა, ციფრული რეკლამა. პროფესიონალური სერვისები თბილისში.',
    'seo.home.keywords': 'ციფრული მარკეტინგი, ვებ განვითარება, სოციალური მედია, რეკლამა, საქართველო, თბილისი, ვიფა ციფრული',

    'seo.about.title': 'ჩვენ შესახებ - ვიფა ციფრული გუნდი',
    'seo.about.description': 'ვიფა ციფრული გუნდის შესახებ. ჩვენი გამოცდილება, მიზნები და ღირებულებები ციფრული მარკეტინგის სფეროში საქართველოში.',
    'seo.about.keywords': 'ვიფა ციფრული გუნდი, ციფრული მარკეტინგის კომპანია, ვებ განვითარება, საქართველო',

    'seo.services.social.title': 'სოციალური მედიის მართვა - ვიფა ციფრული',
    'seo.services.social.description': 'პროფესიონალური სოციალური მედიის მართვა Instagram, Facebook, TikTok-ისთვის. კონტენტის შექმნა, გამოქვეყნება და ანალიტიკა.',
    'seo.services.social.keywords': 'სოციალური მედია, Instagram მართვა, Facebook მარკეტინგი, TikTok, კონტენტის შექმნა',

    'seo.services.ads.title': 'ციფრული რეკლამა - ვიფა ციფრული',
    'seo.services.ads.description': 'Google Ads, Facebook და Instagram სარეკლამო კამპანიების მართვა. ROI ოპტიმიზაცია და გაყიდვების ზრდა.',
    'seo.services.ads.keywords': 'Google Ads, Facebook რეკლამა, Instagram რეკლამა, PPC, ციფრული რეკლამა',

    'seo.services.webdev.title': 'ვებ განვითარება - ვიფა ციფრული',
    'seo.services.webdev.description': 'რესპონსული ვებსაიტები და ონლაინ მაღაზიების განვითარება. SEO ოპტიმიზაცია, უსაფრთხოება და სწრაფი ჩატვირთვა.',
    'seo.services.webdev.keywords': 'ვებ განვითარება, ონლაინ მაღაზია, ვებსაიტის შექმნა, SEO, რესპონსული დიზაინი',

    'seo.startProject.title': 'პროექტის დაწყება - ვიფა ციფრული',
    'seo.startProject.description': 'დაიწყეთ თქვენი ციფრული პროექტი ვიფა ციფრულთან. უფასო კონსულტაცია და პერსონალიზირებული გამოსავლები.',
    'seo.startProject.keywords': 'პროექტის დაწყება, კონსულტაცია, ციფრული მარკეტინგი, ვებ განვითარება',

    // NewHome page
    'newHome.badge': 'გააციფრულე შენი ბიზნესი',
    'newHome.hero.title': 'საკომუნიკაციო ხიდი',
    'newHome.hero.brand': 'ბრენდსა',
    'newHome.hero.connection': 'და მომხმარებელს შორის',
    'newHome.hero.description': 'ჩვენ გვჯერა, რომ ყოველი ბიზნესი უნიკალურია და საჭიროებს ინდივიდუალურ მიდგომას. ამიტომაც ჩვენი ყოველი პროექტი იწყება კლიენტის საჭიროებების ღრმა გაგებით.',
    ...
    'newHome.services.strategic': 'სტრატეგიული მიდგომა ყოველი ბრენდისთვის',
    'newHome.services.digital': 'სრული ციფრული მარკეტინგის გამოსავლები',
    'newHome.services.results': 'რეალური შედეგები და მზარდი ROI',
    'newHome.partners.title': 'ვინ ენდობა ჩვენ',
