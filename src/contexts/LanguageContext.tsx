...
const translations = {
  ka: {
    ...
    "seo.services.social.title": "სოციალური მედიის მართვა - Vifa Digital | vifadigital.com",
    ...
    "seo.services.ads.title": "ციფრული რეკლამა - Vifa Digital | vifadigital.com"
    ...
    "seo.services.webdev.title": "ვებ განვითარება - Vifa Digital | vifadigital.com"
   ...
   , "seo.startProject.keywords":
    ...
    "newHome.interactive.step1.description": "ვიკვლევთ შენს კლიენტებს: ვინ არიან, სად ატარებენ დროს ონლაინ, რა აინტერესებთ",

    "newHome.interactive.step2.title": "2. სტრატეგია",
    "newHome.interactive.step2.subtitle": "სწორი გზის დაგეგმვა",
    "newHome.interactive.step2.description": "ვქმნით კონკრეტულ გეგმას: რომელ პლატფორმაზე, რა კონტენტით, რა ბიუჯეტით",

    "newHome.interactive.step3.title": "3. განხორციელება",
    "newHome.interactive.step3.subtitle": "კამპანიების გაშვება",
    "newHome.interactive.step3.description": "ვაშვებთ რეკლამებს, ვაქვეყნებთ კონტენტს, ვაკონტროლებთ ყველაფერს",

    "newHome.interactive.step4.title": "4. შედეგი",
    "newHome.interactive.step4.subtitle": "გაზომვა და გაუმჯობესება",
    "newHome.interactive.step4.description": "ვზომავთ რეალურ შედეგებს და ვაუმჯობესებთ რაც არ მუშაობს",
    ...
    "newHome.interactive.challenge1.description": "მომხმარებლის ყურადღება მხოლოდ 3-8 წამით იზიდება. პირველი შთაბეჭდილება გადამწყვეტია.",

    "newHome.interactive.challenge2.icon": "📱",
    "newHome.interactive.challenge2.title": "მობილური გამოცდილება",
    "newHome.interactive.challenge2.description": "75%-ზე მეტი ტრეფიკი მოდის სმარტფონიდან. ვებსაიტი უნდა იყოს სწრაფი და მარტივი მობილურზე.",

    "newHome.interactive.challenge3.icon": "🤖",
    "newHome.interactive.challenge3.title": "ახალი ტექნოლოგიები",
    "newHome.interactive.challenge3.description": "AI, ავტომატიზაცია და სწრაფად ცვალებადი პლატფორმები. ყოველთვის უნდა იყო განახლებული.",

    "newHome.interactive.challenge4.icon": "🌍",
    "newHome.interactive.challenge4.title": "გლობალური კონკურენცია",
    "newHome.interactive.challenge4.description": "ონლაინ სივრცეში ყველა კონკურენტი ხილულია. გამოსარჩევად უნდა იყო უნიკალური და პროფესიონალური.",
