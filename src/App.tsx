    ...
    <div className="relative z-10 flex items-center justify-center min-h-screen">
      <div className="flex flex-col items-center space-y-8">
        ...
        <div className="relative">
          ...
          <div
            className="absolute top-4 left-4 w-12 h-12 border border-gray-600/30 border-b-blue-300 rounded-full animate-spin"
        ...
        <div className="text-center space-y-3">
          ...
          <div className="flex space-x-2 justify-center">
            <div
              className="w-1.5 h-1.5 bg-gradient-to-r from-gray-400 to-blue-400 rounded-full animate-bounce opacity-70"
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      Promise.all([
        ...
        ([{ initializePerformanceOptimizations }, { addResourceHints }]) => {
