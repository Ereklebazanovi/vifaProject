...
const WebDevelopment = () => {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-500 ${
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <div className="fade-in-up">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              ...
              <br />
              <span className={`drop-shadow-lg ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>{t('webdev.hero.title2')}</span>
            </h1>
      ...
      {/* კომპაქტური პაკეტები */}
      <section id="packages" className={`py-12 px-6 ${isDarkMode ? 'bg-slate-900/50' : 'bg-slate-100/30'}`}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-6 mb-12 max-w-6xl mx-auto">
            {/* ბეისიქ პაკეტი */}
            <div className={`package-card p-6 rounded-2xl border-2 shadow-xl relative overflow-hidden fade-in-up delay-100 ${isDarkMode ? 'bg-gradient-to-br from-slate-800 to-slate-900 border-blue-400/40' : 'bg-white/80 border-blue-400/60'}`}>
            ...
            {/* სტანდარტი პაკეტი */}
            <div className={`package-card p-6 rounded-2xl border-2 shadow-xl relative overflow-hidden fade-in-up delay-200 ${isDarkMode ? 'bg-gradient-to-br from-slate-800 to-slate-900 border-yellow-400/40' : 'bg-white/80 border-yellow-400/60'}`}>
            ...
            {/* პრემიუმი პაკეტი */}
            <div className={`package-card p-6 rounded-2xl border-2 shadow-xl relative overflow-hidden fade-in-up delay-300 ${isDarkMode ? 'bg-gradient-to-br from-slate-800 to-slate-900 border-green-400/60' : 'bg-white/80 border-green-400/70'}`}>
          ...
          {/* SEO გარანტია სექცია */}
          <div className={`rounded-2xl p-8 border fade-in-up delay-400 ${isDarkMode ? 'bg-gradient-to-r from-green-900/30 to-blue-900/30 border-green-400/20' : 'bg-gradient-to-r from-green-50/50 to-blue-50/50 border-green-400/30'}`}>
            <div className="text-center mb-6">
              ...
              <p className={`max-w-3xl mx-auto ${isDarkMode ? 'text-slate-300' : 'text-slate-600'}`}>
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className={`text-center p-4 rounded-lg ${isDarkMode ? 'bg-slate-800/30' : 'bg-white/50'}`}>
                ...
                <p className={`text-sm ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>{t('webdev.seo.feature1.desc')}</p>
              </div>
              <div className={`text-center p-4 rounded-lg ${isDarkMode ? 'bg-slate-800/30' : 'bg-white/50'}`}>
                <FaBolt className="text-3xl text-blue-400 mx-auto mb-3" />
                <h4 className={`font-semibold mb-2 ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>{t('webdev.seo.feature2.title')}</h4>
                <p className={`text-sm ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>{t('webdev.seo.feature2.desc')}</p>
              </div>
              <div className={`text-center p-4 rounded-lg ${isDarkMode ? 'bg-slate-800/30' : 'bg-white/50'}`}>
                <FaShieldAlt className="text-3xl text-purple-400 mx-auto mb-3" />
                <h4 className={`font-semibold mb-2 ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>{t('webdev.seo.feature3.title')}</h4>
              ...
              <div className={`text-center p-4 rounded-lg ${isDarkMode ? 'bg-slate-800/30' : 'bg-white/50'}`}>
                ...
                <h4 className={`font-semibold mb-2 ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>{t('webdev.seo.feature4.title')}</h4>
                <p className={`text-sm ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>{t('webdev.seo.feature4.desc')}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className={`relative py-20 px-6 overflow-hidden ${isDarkMode ? '' : 'bg-slate-50/30'}`}>
        {/* Dynamic Background */}
        <div className={`absolute inset-0 ${isDarkMode ? 'bg-gradient-to-br from-slate-900 via-purple-900/30 to-blue-900/40' : 'bg-gradient-to-br from-blue-50/30 via-purple-50/20 to-slate-50/40'}`}></div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="text-center mb-16 fade-in-up">
            <div className="flex items-center justify-center gap-4 mb-6">
              ...
              <h2 className="text-4xl md:text-5xl font-bold">
                <span className={isDarkMode ? 'text-white' : 'text-slate-900'}>{t('webdev.vercel.title1')}</span>{" "}
                <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
                  {t('webdev.vercel.title2')}
                </span>
              </h2>
            </div>
            <div className={`backdrop-blur-sm rounded-2xl p-8 border ${isDarkMode ? 'bg-gradient-to-r from-blue-900/30 to-purple-900/30 border-blue-400/20' : 'bg-white/70 border-blue-400/40'}`}>
              <p className={`text-2xl max-w-4xl mx-auto leading-relaxed ${isDarkMode ? 'text-slate-200' : 'text-slate-700'}`}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="slide-in-left delay-200">
              <div className={`relative backdrop-blur-sm rounded-3xl p-8 border shadow-2xl overflow-hidden ${isDarkMode ? 'bg-gradient-to-br from-slate-800/80 to-slate-900/80 border-blue-400/40' : 'bg-white/80 border-blue-400/50'}`}>
                  ...
                  {[
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className={`text-sm ${isDarkMode ? 'text-slate-300' : 'text-slate-600'}`}>{feature.desc}</p>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                {/* Hosting Comparison */}
                <div className={`rounded-lg p-6 border ${isDarkMode ? 'bg-gradient-to-r from-green-900/30 to-blue-900/30 border-green-400/30' : 'bg-green-50/50 border-green-400/40'}`}>
            ...
            <div className="slide-in-right delay-400">
              <div className={`rounded-2xl p-6 border shadow-xl ${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white/80 border-slate-300'}`}>
                <div className="flex items-center justify-between mb-6">
                  <h4 className={`text-xl font-semibold flex items-center gap-2 ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-gradient-to-br from-blue-600/20 to-blue-800/20 rounded-lg p-4 border border-blue-500/30">
                    ...
                    <div className={`text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>1,847</div>
                  ...
                  <div className="bg-gradient-to-br from-green-600/20 to-green-800/20 rounded-lg p-4 border border-green-500/30">
                    ...
                    <div className={`text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>8.2K</div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className={`w-full rounded-full h-2 ${isDarkMode ? 'bg-slate-700' : 'bg-slate-300'}`}>
                ...
                {/* Performance Metrics */}
                <div className={`rounded-lg p-4 ${isDarkMode ? 'bg-slate-700/50' : 'bg-slate-200/50'}`}>
                  ...
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div>
                      ...
                      <div className={`text-xs ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>{t('webdev.analytics.loading')}</div>
                    </div>
                    <div>
                      <div className="text-lg font-bold text-blue-400">97</div>
                      <div className={`text-xs ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>{t('webdev.analytics.speedScore')}</div>
                    </div>
                    <div>
                      <div className="text-lg font-bold text-purple-400">
                        100%
                      </div>
                      <div className={`text-xs ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>{t('webdev.analytics.uptime')}</div>
                    </div>
                  </div>
                </div>

                {/* Analytics Value Prop */}
                <div className={`mt-6 rounded-lg p-4 border ${isDarkMode ? 'bg-gradient-to-r from-blue-900/30 to-purple-900/30 border-blue-400/30' : 'bg-blue-50/50 border-blue-400/40'}`}>
      ...
      <section className={`py-12 px-6 ${isDarkMode ? '' : 'bg-gradient-to-br from-slate-50 to-blue-50/30'}`}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
            <div className="tech-card text-center">
              <div className={`p-6 rounded-xl border scale-in delay-100 ${isDarkMode ? 'bg-slate-800/50 border-slate-700' : 'bg-white/70 border-slate-300'}`}>
                <FaReact className="text-5xl text-blue-400 mx-auto mb-3" />
                <div className={`font-bold text-lg mb-1 ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>React</div>
                <div className={`text-sm ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>{t('webdev.tech.react')}</div>
              </div>
            </div>
            <div className="tech-card text-center">
              <div className={`p-6 rounded-xl border scale-in delay-200 ${isDarkMode ? 'bg-slate-800/50 border-slate-700' : 'bg-white/70 border-slate-300'}`}>
                <SiTypescript className="text-5xl text-blue-500 mx-auto mb-3" />
                <div className={`font-bold text-lg mb-1 ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>TypeScript</div>
                <div className={`text-sm ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>{t('webdev.tech.typescript')}</div>
              </div>
            </div>
            <div className="tech-card text-center">
              <div className={`p-6 rounded-xl border scale-in delay-300 ${isDarkMode ? 'bg-slate-800/50 border-slate-700' : 'bg-white/70 border-slate-300'}`}>
                <SiFirebase className="text-5xl text-yellow-400 mx-auto mb-3" />
                <div className={`font-bold text-lg mb-1 ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>Firebase</div>
                <div className={`text-sm ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>{t('webdev.tech.firebase')}</div>
              </div>
            </div>
            <div className="tech-card text-center">
              <div className={`p-6 rounded-xl border scale-in delay-400 border-blue-400/40 ${isDarkMode ? 'bg-slate-800/50' : 'bg-white/70'}`}>
                <SiVercel className={`text-5xl mx-auto mb-3 ${isDarkMode ? 'text-white' : 'text-slate-800'}`} />
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className={`hover-lift text-center p-6 rounded-xl border fade-in-up delay-100 ${isDarkMode ? 'bg-slate-900/50 border-slate-700' : 'bg-white/70 border-slate-300'}`}>
            ...
            <div className={`hover-lift text-center p-6 rounded-xl border fade-in-up delay-200 ${isDarkMode ? 'bg-slate-900/50 border-slate-700' : 'bg-white/70 border-slate-300'}`}>
            ...
            <div className={`hover-lift text-center p-6 rounded-xl border fade-in-up delay-300 ${isDarkMode ? 'bg-slate-900/50 border-slate-700' : 'bg-white/70 border-slate-300'}`}>
              <FaShieldAlt className="text-4xl text-purple-400 mx-auto mb-4" />
              <h3 className={`text-lg font-semibold mb-3 ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>{t('webdev.guarantees.3.title')}</h3>
              <p className={isDarkMode ? 'text-slate-400' : 'text-slate-600'}>
      ...
      <section className={`py-12 px-6 ${isDarkMode ? 'bg-gradient-to-r from-green-900/40 to-blue-900/40' : 'bg-gradient-to-r from-green-100/50 to-blue-100/50'}`}>
        <div className="max-w-4xl mx-auto text-center">
          <div className="fade-in-up">
            ...
            <div className={`rounded-xl p-6 max-w-2xl mx-auto border ${isDarkMode ? 'bg-slate-800/50 border-slate-600/50' : 'bg-white/70 border-slate-300/50'}`}>
              <p className={`text-lg mb-3 ${isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>
