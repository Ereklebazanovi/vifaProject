...
const WebDev: React.FC = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "ხელოვნური ინტელექტის API-ების ინტეგრაცია",
      color: "orange",
      features: [
        "Chatbot APIs",
        "AI Analysis",
  ...
  return (
    <>
      ...
      <BeautifulBackground className="fixed inset-0 z-0" variant="green" />
        ...
        >
          ...
          <div className="max-w-6xl mx-auto mb-32">
            <div className="text-center mb-16">
              ...
              >
                დღევანდელ ციფრულ სამყაროში, თქვენი ვებსაიტი არის თქვენი ბიზნესის
                სახე. ჩვენ ვქმნით მოდერნულ, სწრაფ და ეფექტურ ვებ აპლიკაციებს,
                რომლებიც ზრდის თქვენს ბიზნესს და აუმჯობესებს მომხმარებელთა
                გამოცდილებას.
              </motion.p>
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              <h3 className="text-3xl font-light text-white mb-4">
                🤖 AI ჩატბოტი თქვენი ბიზნესისთვის
              </h3>
              <p className="text-lg text-slate-300 max-w-3xl mx-auto">
                Facebook Messenger, WhatsApp, Instagram-ში ავტომატური მხარდაჭერა
                24/7
              </p>
            </div>
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-slate-300 max-w-3xl mx-auto">
                ყველა პროექტი უნიკალურია, ამიტომ კლიენტებს ვთავაზობთ ინდივიდუალურ
                ფასებს. <br /> ჩვენი მიზანია მაქსიმალური ღირებულების მიწოდება კლიენტის ბიუჯეტის ფარგლებში.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 p-6 rounded-xl border border-green-500/20">
                ...
                <p className="text-slate-300 text-sm mb-4 leading-relaxed">
                  სრული ვებსაიტი თქვენი კომპანიისთვის: რამდენიმე გვერდი,
                  მარტივი მართვის სისტემა, ძიების ძრავებში უკეთესი ჩვენება და
           ...
           <div className="text-center mb-12 mt-15">
              <h3 className="text-3xl font-light text-white mb-4">
                კონსლუტაცია და თანამშრომლობის დაგეგმვა რათქმაუნდა უფასოა
              </h3>
          ...
          <div className="text-center">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-lg text-slate-300 mb-8">
                დაუკავშირდით ჩვენს გუნდს და დავიწყოთ თქვენი მომავლისგან
                ვებსაიტის შექმნა დღესვე. გარანტირებული ხარისხი და სწრაფი ვადები.
              </p>
