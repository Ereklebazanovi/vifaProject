  ...
  ka: [
    {
      ...
      answer:
        "ჩვენი სრულფასოვანი პაკეტი მოიცავს სოციალური მედიის კომპლექსურ მართვას, პროფესიონალურ  ფოტო ვიდეო და გადაღება, სტრატეგიული კონტენტის შექმნას, ბრენდინგსა და გრაფიკულ დიზაინს. ჩვენ ვუზრუნველყოფთ თქვენი ბიზნესის სრულყოფილ ციფრულ პოზიციონირებას."
    },
    {
      ...
      <section className="relative min-h-[75vh] w-full flex items-center justify-start overflow-hidden pt-32 lg:pt-0">
        <div className="absolute inset-0 z-0 overflow-hidden">
          <div 
            ...
            style={{ backgroundImage: 'url("/marketphoto.webp")' }}
          />
        </div>
{/* sadasd */}
