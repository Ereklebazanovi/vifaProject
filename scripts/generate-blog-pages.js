...
const blogPosts = {
  ...
  'ratom-stsirdeba-bizness-vebsaiti-tanamendove-epoqashi': {
    title: 'რატომ სჭირდება ბიზნესს ვებსაიტი თანამედროვე ეპოქაში?',
    description: 'პროფესიონალური ვებსაიტი არა მხოლოდ ხილვადობას უზრუნველყოფს, არამედ ზრდის შესაძლებლობებს და ეფექტურობას. თანამედროვე ეპოქაში ეს აუცილებელია.',
